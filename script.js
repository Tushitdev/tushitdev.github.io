...
const animateElements = document.querySelectorAll('.timeline-item, .skill-category, .project-card, .education-card');
...
const cards = document.querySelectorAll('.stat-card, .skill-category, .project-card, .education-card');
cards.forEach(card => {
...
function createScrollTopButton() {
    ...
    scrollBtn.addEventListener('mouseleave', () => {
        ...
        scrollBtn.style.boxShadow = '0 5px 15px rgba(37, 99, 235, 0.3)';
    });
}
...
console.log('%cWelcome to Tushit Dev Maheshkumar\'s Portfolio', 'color: #64748b; font-size: 14px;');
